...
public class GetBrandsByCategory extends UseCase {
    private final int id;
    private final BrandRepository brandRepository;

    @Inject
    public GetBrandsByCategory(int id, BrandRepository brandRepository, ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return this.brandRepository.brandsByCategory(this.id);
    }
}
